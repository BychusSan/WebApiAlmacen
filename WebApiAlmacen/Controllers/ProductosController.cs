...
namespace WebApiAlmacen.Controllers
{
    ...
    public class ProductosController : ControllerBase
    {
        ...
        //// Inyectamos el servicio de gestión de archivos
        ...
        //public ProductosController(MiAlmacenContext context, GestorArchivosLocal gestorArchivosLocal, OperacionesService operacionesService)
        //{
        //    _context = context;
        ...
        public async Task<ActionResult> GetFiltroMultiple([FromQuery] DTOProductosFiltro filtroProductos)
        {
            ...
            if (!string.IsNullOrEmpty(filtroProductos.ContieneEnNombre))
            {
                productosQueryable = productosQueryable.Where(x => x.Nombre.Contains(filtroProductos.ContieneEnNombre));
            }
